    ...
    **kwargs,
    ...
    if flask.request.method == "POST":
        ...
        if response and "error" in response:
            ...
            return flask.render_template(
                "/credentialling/schedule.html", error=error
            )
        else:
            exam = {
            ...
            return flask.render_template(
                "/credentialling/schedule-confirm.html", exam=exam
            )
...
def cred_your_exams(
    ...
    **kwargs,
            ...
            if assessment_id and now > starts_at and now < end:
                actions.extend(
                    [
                        {
                            "text": "Take exam",
                            "href": f"/credentialling/exam?id={ assessment_id }",
            ...
            if r["state"] == "scheduled":
                actions.extend(
                    [
                        {
                            "text": "Reschedule",
                            "href": f"/credentialling/schedule?uuid={ r['uuid'] }",
                            "button_class": "p-button",
                        },
                        {
                            "text": "Cancel",
                            "href": f"/credentialling/cancel-exam?uuid={ r['uuid'] }",
    ...
    return flask.render_template(
        "credentialling/your-exams.html",
        exams=exams,
        #  url=url,
        #  key_len=key_len,
        #  tb=tb,
...
def cred_cancel_exam(
    ...
    **kwargs,
    ...
    return flask.redirect("/credentialling/your-exams")
...
def cred_assessments(
    ...
    **kwargs,
    ...
    return flask.render_template("credentialling/assessments.html", exams=exams)
